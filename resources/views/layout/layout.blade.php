...
<head>
    ...
    <meta name="description" content="Cà Phê Thanh Niên Trường Đại học Cần Thơ khu Hòa An">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="{{ url('public/images/logo-cftn.png') }}">
    <link rel="shortcut icon" href="{{ url('public/images/logo-cftn.png') }}">
    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./">
                <img src="{{ url('public/images/logo-cftn-text.jpg') }}" alt="Logo" style="border-radius:4px;">
            </a>
            <a class="navbar-brand hidden" href="./">
                <img src="{{ url('public/images/logo-cftn.jpg') }}" alt="Logo" style="border-radius:5px;">
            </a>
        </div>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active">
                    <a href="#"> <i class="menu-icon fa fa-dashboard"></i>Bảng điều khiển </a>
                </li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-chevron-right"></i><a href="ui-buttons.html">Quyền truy cập</a></li>
                        <li><i class="fa fa-chevron-right"></i><a href="ui-buttons.html">Quản trị</a></li>
                        <li><i class="fa fa-chevron-right"></i><a href="ui-badges.html">Nhân viên</a></li>
                        <li><i class="fa fa-chevron-right"></i><a href="ui-badges.html">Khách hàng</a></li>
                    </ul>
                </li>

                <li>
                    <a href="widgets.html">
                        <i class="menu-icon fa fa-briefcase"></i>CÔNG VIỆC
                    </a>
                </li>

                <li>
                    <a href="widgets.html">
                        <i class="menu-icon fa fa-money"></i>HÓA ĐƠN THANH TOÁN
                    </a>
                </li>

                <li>
                    <a href="widgets.html">
                        <i class="menu-icon fa fa-pencil-square-o"></i>SOẠN HÓA ĐƠN
                    </a>
                </li>

                <li>
                    <a href="widgets.html">
                        <i class="menu-icon fa fa-table"></i>CA LÀM VIỆC
                    </a>
                </li>

                <li>
                    <a href="widgets.html">
                        <i class="menu-icon fa fa-cubes"></i>SẢN PHẨM
                    </a>
                </li>
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    ...
                    <div class="user-menu dropdown-menu">
                        <a class="nav-link" href="#"><i class="fa fa-user"></i> Hồ sơ cá nhân</a>
